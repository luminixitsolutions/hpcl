...
if ($_POST['action'] == 'Add') {
    ...
    try {
        ...
        $fields = [
            ...
            'ClassId', 'McDesc', 'BrandDesc', 'Status', 'SrNo'
        ];
        ...
        if (empty($id)) {
            ...
            /*if (!empty($BrandId)) {
                $sql = "INSERT INTO tbl_vendor_products 
                        SET ProdId='$id', Division='$Division', Segment='$Segment', Family='$Family', ClassId='$ClassId',
                            McDesc='$McDesc', BrandDesc='$BrandDesc', SubTotal='$SubTotal', DiscPer='$DiscPer', Discount='$Discount',
                            Unit='$Unit', PurchasePrice='$PurchasePrice', Transfer='$Transfer', ProdType2='$ProdType2',
                            BrandId='$BrandId', SubCatId='$SubCatId', ProductName='$ProductName', CatId='$CatId',
                            MinPrice='$MinPrice', Status='$Status', SrNo='$SrNo', CreatedDate='$CreatedDate',
            ...
            // 🟠 If product is inactive, update flags
            if ($Status == 0) {
                ...
                $flagQuery = "UPDATE tbl_vendor_products 
                              SET checkstatus=0, push_flag=1, delete_flag=1, modified_time='$modified_time'
                              WHERE ProdId='$id'";
                if (!$conn->query($flagQuery)) throw new Exception("Flag Update Error: " . $conn->error);
            }
