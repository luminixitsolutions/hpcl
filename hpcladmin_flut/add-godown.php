...
<head>
    <title><?php echo $Proj_Title; ?> - <?php if($_GET['id']) {?>Edit <?php } else{?> Add <?php } ?> Godown Account
    </title>
    <meta charset="utf-8">
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0"><?php if($_GET['id']) {?>Edit <?php } else{?> Add
                            <?php } ?> Godown Account</h4>

                        <div class="card mb-4">
                            <div class="card-body">
                                <div id="alert_message"></div>
                                <form id="validation-form" method="post" autocomplete="off" action="ajax_files/ajax_godown.php" enctype="multipart/form-data">
 ...
 <legend>Personal Detail</legend>
                                    <div class="form-row">
                                       ...
                                       <div class="form-group col-md-12">
                                            <label class="form-label">Godown Name <span
...
<input type="hidden" Name="Roll" id="Roll" value="93">
<div class="row">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data == 0) {
                            ...
                            success_toast();
                            setTimeout(function() {
                                window.location.href = 'view-godown.php';
                            }, 2000);
                        }
