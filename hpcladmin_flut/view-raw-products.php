...
<a href="add-raw-products.php" class="btn btn-secondary btn-round"><i class="ion ion-md-add mr-2"></i> Add New</a></span><?php } ?>
</h4>
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
        ...
        <tbody>
            ...
            $sql = "SELECT tp.*,tc.Name As CatName,tcs.Name As SubCatName FROM tbl_cust_products2 tp 
                    ...
                    LEFT JOIN tbl_cust_sub_category_2025 tcs ON tcs.id=tp.SubCatId WHERE tp.ProdType='1' AND tp.OldNew=1 ORDER BY tp.CreatedDate DESC";
            $res = $conn->query($sql);
           ...
           <?php if(in_array("10", $Options) || in_array("11", $Options)) {?>
            <td>
              ...
              <a href="add-raw-products.php?id=<?php echo $row['id']; ?>" ><i class="lnr lnr-pencil mr-2"></i></a>
