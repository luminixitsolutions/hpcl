...
<head>
    <title><?php echo $Proj_Title; ?> - <?php if($_GET['id']) {?>Edit <?php } else{?> Add <?php } ?> Financer Account
    </title>
    <meta charset="utf-8">
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0"><?php if($_GET['id']) {?>Edit <?php } else{?> Add
                            <?php } ?> Financer/Partner Account</h4>

                        <div class="card mb-4">
                            <div class="card-body">
                                <div id="alert_message"></div>
                                <form id="validation-form" method="post" autocomplete="off" action="ajax_files/ajax_financer.php" enctype="multipart/form-data">
 ...
 <legend>Personal Detail</legend>
                                    <div class="form-row">
                                       ...
                                       <div class="form-group col-md-12">
                                            <label class="form-label">Financer/Partner Name <span
...
<div class="clearfix"></div>
                                        ...
                                        <div class="form-group col-md-3">
                                            <label class="form-label">Commision Percentage <span class="text-danger">*</span></label>
                                            <input type="text" name="Percentage" class="form-control"
                                                placeholder="" value="<?php echo $row7["Percentage"]; ?>" required>
                                            <div class="clearfix"></div>
                                        </div>
...
<input type="hidden" Name="Roll" id="Roll" value="105">
<div class="row">
...
<fieldset>
    <legend>
        ...
        <input type="checkbox" id="selectAllCoco" style="margin-left:10px;">  Coco Franchise Access
    </legend>

    <div class="form-row">
        <?php  
            $sql33 = "SELECT * FROM tbl_users_bill WHERE OwnFranchise=1 AND Roll=5 AND Status=1";
            $row33 = getList($sql33);
        ...
        <?php } ?>
                                     ...
                                     <fieldset>
 <legend><input type="checkbox" id="selectAllFofo" style="margin-left:10px;">  FOFO Franchise Access</legend>
<div class="form-row">               
                                    
                                    <?php  
                                        $sql33 = "SELECT * FROM  tbl_users_bill WHERE OwnFranchise=2 AND Roll=5 AND Status=1";
                                        $row33 = getList($sql33);
                                        foreach($row33 as $result){
                                        ?>
                                        <div class="form-group col-md-6">
                                            <label class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input fofo-checkbox" name="CocoFranchiseAccess[]" value="<?php echo $result['id'];?>" <?php if(in_array($result["id"],$row7['CocoFranchiseAccess'])) { ?>
                        ...
                        checked="checked" <?php } ?>>
                                    ...
                                    <?php } ?>
                                     ...
                                     <fieldset>
 <legend><input type="checkbox" id="selectAllFoco" style="margin-left:10px;"> FOCO Franchise Access</legend>
<div class="form-row">               
                                    
                                    <?php  
                                        $sql33 = "SELECT * FROM  tbl_users_bill WHERE OwnFranchise=3 AND Roll=5 AND Status=1";
                                        $row33 = getList($sql33);
                                        foreach($row33 as $result){
                                        ?>
                                        <div class="form-group col-md-6">
                                            <label class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input foco-checkbox" name="CocoFranchiseAccess[]" value="<?php echo $result['id'];?>" <?php if(in_array($result["id"],$row7['CocoFranchiseAccess'])) { ?>
                        ...
                        checked="checked" <?php } ?>>
                                    ...
                                    <?php } ?>
                                     ...
                                     <fieldset>
 <legend><input type="checkbox" id="selectAllCofo" style="margin-left:10px;">COFO Franchise Access</legend>
<div class="form-row">               
                                    
                                    <?php  
                                        $sql33 = "SELECT * FROM  tbl_users_bill WHERE OwnFranchise=4 AND Roll=5 AND Status=1";
                                        $row33 = getList($sql33);
                                        foreach($row33 as $result){
                                        ?>
                                        <div class="form-group col-md-6">
                                            <label class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input cofo-checkbox" name="CocoFranchiseAccess[]" value="<?php echo $result['id'];?>" <?php if(in_array($result["id"],$row7['CocoFranchiseAccess'])) { ?>
