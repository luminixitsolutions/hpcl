...
<div class="row">
<div class="col-lg-7">
<form id="validation-form" method="post" enctype="multipart/form-data" action="save-selling-stock.php">
<div class="form-row">
...
<?php 
  $sql12 = "SELECT id,ProductName,MinPrice FROM tbl_cust_products_2025 WHERE Status='1' AND CreatedBy='$BillSoftFrId' AND delete_flag=0 AND ProdType=0 AND ProdType2!=2 AND checkstatus=1";
  $row12 = getList($sql12);
  foreach($row12 as $result){
     ?>
...
<input type="number" name="Qty" id="Qty" class="form-control" placeholder="" value="<?php echo $row7["Qty"]; ?>" autocomplete="off">
<div class="clearfix"></div>
    </div>
<?php } else{?>
    <div class="form-group col-md-2">
<label class="form-label">Stock In Qty </label>
<input type="number" name="Qty" id="Qty" class="form-control" placeholder="" value="<?php echo $row7["Qty"]; ?>" autocomplete="off" min="1">
<div class="clearfix"></div>
    </div>
    <?php } ?>
...
<input type="text" name="PurchasePrice" id="PurchasePrice" class="form-control" placeholder="" value="" autocomplete="off" >
<div class="clearfix"></div>
    </div>
