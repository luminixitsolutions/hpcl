...
<h4 class="font-weight-bold py-3 mb-0">Raw Product Wastage Stock</h4>
...
<?php 
  $sql12 = "SELECT tp.ProductName,tp.id FROM tbl_cust_products_2025 tp WHERE tp.CreatedBy='$BillSoftFrId' AND tp.checkstatus=1 AND tp.ProdType='1' AND tp.Status=1 ORDER BY tp.ProductName";
  $row12 = getList($sql12);
...
<div class="input-group">
    <input type="text" name="Qty2" id="Qty2" class="form-control" placeholder="" value="<?php echo $row7["Qty2"]; ?>" autocomplete="off"  oninput="covertIt(document.getElementById('Qty2').value,document.getElementById('QtyUnit2').value)">
        <div class="input-group-append">
 ...
 function addToCart(){
     ...
     if(ProdId==''){
         ...
         alert("Please Enter Qty");
            ...
            $.ajax({
                url: "ajax_files/ajax_wastage_raw_products_2025.php",
                method: "POST",
                data: {
                    action: action,
                    code: code,
