...
<option selected="" value="">Select Product</option>
 <?php 
  ...
  $sql12 = "SELECT id,ProductName,ProdType2 FROM tbl_cust_products_2025 WHERE Status='1' AND CreatedBy='$BillSoftFrId' AND checkstatus=1 AND ProdType='1'  ORDER BY ProductName";
  $row12 = getList($sql12);
  foreach($row12 as $result){
    $ProdType2 = "RAW";
     ?> 
