...
<head>
    <title><?php echo $Proj_Title; ?> - <?php if($_GET['id']) {?>Edit <?php } else{?> Add <?php } ?> Retailer Account
    </title>
    <meta charset="utf-8">
                ...
                <div class="layout-content">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        <h4 class="font-weight-bold py-3 mb-0"><?php if($_GET['id']) {?>Edit <?php } else{?> Add
                            <?php } ?> Retailer Account</h4>

                        <div class="card mb-4">
                            <div class="card-body">
                                <div id="alert_message"></div>
                                <form id="validation-form" method="post" autocomplete="off" action="ajax_files/ajax_retailer.php" enctype="multipart/form-data">
 ...
 <legend>Personal Detail</legend>
                                    <div class="form-row">
                                       ...
                                       <div class="form-group col-md-12">
                                            <label class="form-label">Retailer Name <span
...
<input type="hidden" Name="Roll" id="Roll" value="95">
<div class="row">
...
<!--<div class="form-group col-md-4">
                                   ...
                                   <!-- <div class="row">
                                        <?php  
                                        $sql33 = "SELECT * FROM tbl_options WHERE id NOT IN(10,11,14) AND BillSoft=1";
                                        $row33 = getList($sql33);
...
<div class="form-row">               
                                    ...
                                    <?php  
                                        $sql33 = "SELECT * FROM  tbl_users_bill WHERE OwnFranchise=1 AND Roll=5";
                                        $row33 = getList($sql33);
                                        foreach($row33 as $result){
                                        ?>
                                        <div class="form-group col-md-6">
                                            <label class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="CocoFranchiseAccess[]" value="<?php echo $result['id'];?>" <?php if(in_array($result["id"],$row7['CocoFranchiseAccess'])) { ?>
    ...
    $(document).ready(function() {
        ...
        $('#validation-form').on('submit', function(e) {
            ...
            if ($('#validation-form').valid()) {
                ...
                $.ajax({
                    url: "ajax_files/ajax_retailer.php",
                    method: "POST",
                    ...
                    success: function(data) {
                        ...
                        if (data == 0) {
                            ...
                            success_toast();
                            setTimeout(function() {
                                window.location.href = 'view-retailer.php';
                            }, 2000);
                        }
