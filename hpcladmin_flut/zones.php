...
<h4 class="font-weight-bold py-3 mb-0">List Of Zone
...
function product_lists(){
  $.ajax({
    type: "POST",
    url: "ajax_files/ajax_zone.php?action=view",
    data: {},
    dataType: "html",
    ...
    error: function(){
      $('#custresult').html('<div class="alert alert-danger">Could not load zones. Refresh the page.</div>');
    }
  });
}
