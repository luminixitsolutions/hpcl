...
<?php } ?>
        ...
        <div class="main-container" style="padding-top: 80px;">
            <div class="container">
                 ...
                 <a href="add-wastage-raw-stock.php" class="btn btn-sm btn-default rounded">Add New</a>
...
$sql = "SELECT * FROM tbl_wastage_invoice WHERE Type=1 AND FrId='$FranchiseId' ORDER BY id DESC";
$row = getList($sql);
    ...
    <div class="card-body">
        <div class="row align-items-center">
            ...
            <div class="col-4 text-right">
                <a href="view-wastage-raw-stocks-products.php?id=<?php echo $result['id']; ?>" class="btn btn-sm btn-success rounded">
                     View
                </a>
            </div>
        </div>
