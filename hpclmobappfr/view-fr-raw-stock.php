                 ...
                 <a href="add-raw-prod-stock.php" class="btn btn-sm btn-default rounded">Add New</a>
                        ...
                        <?php 
                             $sql = "SELECT ts.*,p.ProductName FROM tbl_cust_prod_stock_2025 ts 
                                    INNER JOIN tbl_cust_products_2025 p ON ts.ProdId=p.id WHERE ts.FrId='$FranchiseId' AND ts.Status='Cr' AND ts.Qty>0 AND p.ProdType=1 AND p.checkstatus=1 ORDER BY ts.id DESC";
                            $row = getList($sql);
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <p class="text-secondary"><?php echo date("d/m/Y", strtotime(str_replace('-', '/',$result['StockDate'])))?><br>
                                           Qty : <?php echo $result['Qty2']." ".$result['Unit2'];?>
                                       </p>
