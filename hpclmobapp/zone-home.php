...
<!--<div class="swiper-container categories2tab1 text-center mb-4">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <?php if($ownfr == 1){?>
                            <a href="zone-home.php?ownfr=1&zoneid=<?php echo $_REQUEST['zoneid'];?>&subzoneid=<?php echo $_REQUEST['subzoneid'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-default active rounded">COCO</a>
                            <?php } else {?>
                            <a href="zone-home.php?ownfr=1&zoneid=<?php echo $_REQUEST['zoneid'];?>&subzoneid=<?php echo $_REQUEST['subzoneid'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-outline-default rounded">COCO</a>
                            <?php } ?>
                        </div>
                        <div class="swiper-slide">
                            <?php if($ownfr == 2){?>
                            <a href="zone-home.php?ownfr=2&zoneid=<?php echo $_REQUEST['zoneid'];?>&subzoneid=<?php echo $_REQUEST['subzoneid'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-default active rounded">FOFO</a>
                            <?php } else {?>
                            <a href="zone-home.php?ownfr=2&zoneid=<?php echo $_REQUEST['zoneid'];?>&subzoneid=<?php echo $_REQUEST['subzoneid'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-outline-default rounded">FOFO</a>
                            <?php } ?>
                        </div>
                        <div class="swiper-slide">
                           <?php if($ownfr == 3){?>
                            <a href="zone-home.php?ownfr=3&zoneid=<?php echo $_REQUEST['zoneid'];?>&subzoneid=<?php echo $_REQUEST['subzoneid'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-default active rounded">FOCO</a>
                            <?php } else {?>
                            <a href="zone-home.php?ownfr=3&zoneid=<?php echo $_REQUEST['zoneid'];?>&subzoneid=<?php echo $_REQUEST['subzoneid'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-outline-default rounded">FOCO</a>
                            <?php } ?>
                        </div>
                        
                        <div class="swiper-slide">
                           <?php if($ownfr == 4){?>
                            <a href="zone-home.php?ownfr=4&zoneid=<?php echo $_REQUEST['zoneid'];?>&subzoneid=<?php echo $_REQUEST['subzoneid'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-default active rounded">COFO</a>
                            <?php } else {?>
                            <a href="zone-home.php?ownfr=4&zoneid=<?php echo $_REQUEST['zoneid'];?>&subzoneid=<?php echo $_REQUEST['subzoneid'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>" class="btn btn-sm btn-outline-default rounded">COFO</a>
                            <?php } ?> 
                        </div>
...
function countval($val,$frid,$Calendar){
  ...
  $sql77 = "SELECT GROUP_CONCAT(id) AS frids FROM tbl_users_bill WHERE SubZoneId='$subzoneid' AND ZoneId='$zoneid'";
  $row77 = getRecord($sql77);
   $frids = $row77['frids'];
    
$Calendar = $_REQUEST['calendar'];
 $sql = "SELECT SUM(NetAmount) AS NetAmount,SUM(Discount) AS TotDiscount,COUNT(*) AS TotInv,tc.FrId,tu.ShopName,tu.Address,tu.OwnFranchise FROM tbl_customer_invoice tc INNER JOIN tbl_users_bill tu ON tu.id=tc.FrId WHERE tu.Roll='5'  AND tu.id IN($frids)";
if($Roll != 1){
...
$sql.= " UNION ALL SELECT SUM(NetAmount) AS NetAmount,SUM(Discount) AS TotDiscount,COUNT(*) AS TotInv,tc.FrId,tu.ShopName,tu.Address,tu.OwnFranchise FROM tbl_customer_invoice_2025 tc INNER JOIN tbl_users_bill tu ON tu.id=tc.FrId WHERE tu.Roll='5' AND tu.id IN($frids)";
if($Roll != 1){
    if($CocoFranchiseAccess != '' || $CocoFranchiseAccess != 0){
    $sql.=" AND tu.id IN ($CocoFranchiseAccess)";
    }
                   ...
                   <!-- <a href="product-lists.php?catid=<?php echo $result['id'];?>">-->
                    <div class=" px-0">
                        <ul class="list-group list-group-flush">
                             <a href="../billsoftmobappfr2025/home.php?frid=<?php echo $result['FrId'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>">
                            <li class="list-group-item" style="border-radius: 10px;">
                                
                                <div class="row align-items-center">
                                    <div class="col align-self-center pr-0" width="80%">
                                        <h6 class=" mb-1" style="color:black;font-size:14px;font-weight:500;"><?php echo $result['ShopName'];?> <br>(<?php echo franchiseBadge($result['OwnFranchise']); ?>)</h6>
                                          ...
                                          CROSS SALES : <?= $row22['TotSell']; ?> | &#8377;<?= $row22['NetAmount']; ?> <br>TOTAL DISCOUNT : <?php echo $result['TotDiscount'];?><br></p>
                    ...
                    <?php if($TotNetAmount+$NetAmount3 == 0){?>
                     <div class=" px-0">
                        <ul class="list-group list-group-flush">
                           ...
                           <?php
$TotNetAmount = isset($TotNetAmount) && $TotNetAmount !== '' ? $TotNetAmount : 0;
$rncnt224 = isset($rncnt224) && $rncnt224 !== '' ? $rncnt224 : 0;

$totalAvg = 0;
if ($rncnt224 > 0) {
    $totalAvg = $TotNetAmount / $rncnt224;
}
?>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-auto" align="right">
            <p class="small text-secondary" style="font-size:15px;">
                <strong><?php echo number_format($totalAvg, 2); ?></strong>
            </p>
        </div> 
    </div>
</li>
