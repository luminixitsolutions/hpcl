         ...
         <div class="card mb-2">
                    ...
                    <div class=" px-0">
                        <ul class="list-group list-group-flush">
                             <a href="zone-home.php?zoneid=<?php echo $result['CatId'];?>&subzoneid=<?php echo $result['id'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>">
...
$totalAvg = ($rncnt224 > 0) ? ($TotNetAmount / $rncnt224) : 0;
?>
