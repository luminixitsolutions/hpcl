...
<?php 
$sql = "SELECT * FROM tbl_cust_category_2025 WHERE ProdType=0 ORDER BY Name ASC";
 $row = getList($sql);
 foreach($row as $result){
    $sql2 = "SELECT * FROM tbl_cust_products_2025 WHERE CatId='".$result['id']."' AND checkstatus='1' Group BY ProdId";
    $rncnt2 = getRow($sql2);
    ?>
                <div class="card mb-2">
