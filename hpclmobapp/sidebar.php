...
$CocoFranchiseAccess = $row110['CocoFranchiseAccess'];
$zoneids = $row110['zone'];
$subzoneids = $row110['subzone'];
    ...
    <div class="main-menu">
        ...
        <div class="menu-container">
            ...
            <ul class="nav nav-pills flex-column ">
                <li class="nav-item">
                    <a class="nav-link active" href="home.php?ownfr=1">
                        <div>
...
<li class="nav-item">
                    <a class="nav-link" href="sell-by-category.php">
                        <div>
                            <span class="material-icons icon">checklist</span>
                            Category Wise Sell
                        </div>
...
<!--<li class="nav-item">
               ...
               <!--  <li class="nav-item">
                    <a class="nav-link" href="sell-report.php">
                        <div>
                            <span class="material-icons icon">verified</span>
                           Sell Report
                        </div>
