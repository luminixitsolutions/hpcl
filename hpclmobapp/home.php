                   ...
                   <!-- <a href="product-lists.php?catid=<?php echo $result['id'];?>">-->
                    <div class=" px-0">
                        <ul class="list-group list-group-flush">
                             <a href="sub-zone.php?zoneid=<?php echo $result['id'];?>&calendar=<?php echo $_REQUEST['calendar'];?>&FromDate=<?php echo $_REQUEST['FromDate'];?>&ToDate=<?php echo $_REQUEST['ToDate'];?>">
                                ...
                                <div class="row align-items-center">
                                    <div class="col align-self-center pr-0" width="80%">
                                        <h6 class=" mb-1" style="color:black;font-size:14px;font-weight:500;"><?php echo $result['Name'];?></h6>
                                          ...
                                          <?php
$TotSell = !empty($row_11['TotSell']) ? $row_11['TotSell'] : 0;
$TotalCrossSale = !empty($row99['TotalCrossSale']) ? $row99['TotalCrossSale'] : 0;

// calculate percentage safely
if ($TotalCrossSale > 0) {
    $percentage = ($TotSell / $TotalCrossSale) * 100;
} else {
    $percentage = 0;
}
?>
...
TARGET CROSS SALES : 
<?php echo $TotSell; ?> / <?php echo $TotalCrossSale; ?> 
(<?php echo number_format($percentage, 2); ?>%)<br>
                                    ...
                                    <div class="col-auto" align="right" >
                                         ...
                                         <?php
$NetAmount = !empty($NetAmount) ? $NetAmount : 0;
$TotInv = !empty($row88['TotInv']) ? $row88['TotInv'] : 0;

if ($TotInv > 0) {
    $avg = $NetAmount / $TotInv;
} else {
    $avg = 0;
}
?>
...
<div class="card mb-2">
                    ...
                    <div class=" px-0">
                        <ul class="list-group list-group-flush">
                           ...
                           <?php
$TotNetAmount = !empty($TotNetAmount) ? $TotNetAmount : 0;
$rncnt224 = !empty($rncnt224) ? $rncnt224 : 0;
