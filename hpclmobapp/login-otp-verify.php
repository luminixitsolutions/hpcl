    ...
    <div class="content-body">
        <div class="container vh-100">
            <div class="welcome-area">
               <!-- <div class="bg-image bg-image-overlay" style="background-image: url(pic222.jpg);height:100vh;"></div>-->
                <div class="join-area h-50">
                    <div class="started">
                         <img style="width:200px;" src="logok.jpg"><br>
                        <h1 class="title">OTP Verification</h1>
                        <p>Enter the OTP send to +91 <?php echo $_REQUEST['phone'];?></p>
                    </div>
                   ...
                   <input type="hidden" name="action" class="form-control" value="OtpVerify">
                    ...
                    <div class="seprate-box mb-3">
                        ...
                        <button type="submit" id="submit"  class="btn btn-primary btn-block">Verify</button>
                    </div>
                    </form> 
                </div>
            </div>
                ...
                success:function(data){ 
                 // alert(data);
                  ...
                  var Username = res.Username;
                    ...
                    if(Roll == 0){
                    window.location.href = 'home.php?ownfr=1';
                    }
                    else if(Roll == 105){
