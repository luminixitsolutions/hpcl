...
<!--<div class="container-fluid py-2 px-2 px-md-3">
  ...
  <div>
    <div class="page-title">📦 View Request Orders</div>

    <div class="d-flex align-items-center mb-3" style="gap:10px; flex-wrap:nowrap;">
  <input type="text" id="searchBox" class="form-control" 
         placeholder="Search by Order No, Date, Product, or Amount..."
  ...
  <button id="clearSearch" class="btn btn-outline-secondary" 
    ...
    <div class="table-responsive">
     ...
     $sql = "SELECT o.*
        ...
        <?php } } } else { echo '<tr><td colspan="8" class="no-results">No request orders found.</td></tr>'; } ?>
        </tbody>
      </table>
    </div>
