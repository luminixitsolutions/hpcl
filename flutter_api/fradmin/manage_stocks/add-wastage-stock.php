...
<style>
  ...
  /* ðŸ”¥ BEAUTIFUL PAGINATION STYLE (Matches Your Screenshot) */
  .custom-pagination {
    display: flex;
...
<div>
  ...
  <div class="page-title">Add Wastage Stock</div>
...
$sql = "SELECT id,ProdId,ProductName,MinPrice 
        ...
        WHERE checkstatus=1 AND Status=1 AND CreatedBy='$FrId'
